...
const NodeDetail = ({ isOpen, onClose, resourceName }) => {
        ...
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <tbody>
            ...
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4">
                {resourceDetail?.status?.nodeInfo?.operatingSystem}
              </td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">OS Image</td>
              <td className="px-6 py-4">
                {resourceDetail?.status?.nodeInfo?.osImage}
              </td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">Architecture</td>
              <td className="px-6 py-4">
                {resourceDetail?.status?.nodeInfo?.architecture}
              </td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">ContainerRuntimeVersion</td>
              <td className="px-6 py-4">
                {resourceDetail?.status?.nodeInfo?.containerRuntimeVersion}
              </td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">KubeletVersion</td>
              <td className="px-6 py-4">
                {resourceDetail?.status?.nodeInfo?.kubeletVersion}
              </td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">KernelVersion</td>
              <td className="px-6 py-4">
                {resourceDetail?.status?.nodeInfo?.kernelVersion}
              </td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">Taints</td>
              <td className="px-6 py-4">
                {resourceDetail?.spec?.taints ? (
                  <div>
                    {resourceDetail.spec.taints.map((obj, index) => (
