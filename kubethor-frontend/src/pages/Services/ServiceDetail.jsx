...
const ServiceDetail = ({ isOpen, onClose, resourceName }) => {
    ...
    >
      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <tbody>
            ...
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">Selectors</td>
              <td className="px-6 py-4">
                {resourceDetail?.spec?.selector ? (
                  <div>
                    {Object.entries(resourceDetail.spec.selector).map(
                      ([key, value]) => (
            ...
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td className="px-6 py-4">{resourceDetail?.spec?.type}</td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">Session Affinity</td>
              <td className="px-6 py-4">
                {resourceDetail?.spec?.sessionAffinity}
              </td>
            </tr>
          </tbody>
        </table>
      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <tbody>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">Cluster IP</td>
              <td className="px-6 py-4">{resourceDetail?.spec?.clusterIP}</td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">Cluster IPs</td>
              <td className="px-6 py-4">
                {resourceDetail?.spec?.clusterIPs ? (
                  <div>
                    {resourceDetail.spec.clusterIPs.map((IP, index) => (
            ...
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">IP Families</td>
              <td className="px-6 py-4">
                {resourceDetail?.spec?.ipFamilies ? (
                  <div>
                    {resourceDetail.spec.ipFamilies.map((obj, index) => (
                      <div key={index} className="mb-1">
                        <span className="bg-gray-100 text-gray-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">
                          {obj}
                        </span>
            ...
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">IP Family Policy</td>
              <td className="px-6 py-4">
                {resourceDetail?.spec?.ipFamilyPolicy}
              </td>
            </tr>
          </tbody>
        </table>
