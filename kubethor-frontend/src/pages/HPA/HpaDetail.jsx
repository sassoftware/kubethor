...
const HpaDetail = ({ isOpen, onClose, resourceName }) => {
      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <tbody>
            ...
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">Min Replicas</td>
              <td className="px-6 py-4">{resourceDetail?.spec?.minReplicas}</td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">Max Replicas</td>
              <td className="px-6 py-4">{resourceDetail?.spec?.maxReplicas}</td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">Target Kind</td>
              <td className="px-6 py-4">
                {resourceDetail?.spec?.scaleTargetRef?.kind}
              </td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">Target Name</td>
              <td className="px-6 py-4">
                {resourceDetail?.spec?.scaleTargetRef?.name}
              </td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">CurrentCPUUtilizationPercentage</td>
              <td className="px-6 py-4">
                {resourceDetail?.status?.currentCPUUtilizationPercentage}
              </td>
            </tr>
          </tbody>
        </table>
