...
const PvcDetail = ({ isOpen, onClose, resourceName }) => {
      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg">
        <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <tbody>
            ...
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">Finalizers</td>
              <td className="px-6 py-4">
                {resourceDetail?.metadata?.finalizers ? (
                  <div>
                    {resourceDetail.metadata.finalizers.map((obj, index) => (
                  ...
                  "No AccessModes available"
                )}
              </td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">Access Modes</td>
              <td className="px-6 py-4">
                {resourceDetail?.spec?.accessModes ? (
                  <div>
                    {resourceDetail.spec.accessModes.map((obj, index) => (
                      <div key={index} className="mb-1">
                        <span className="bg-gray-100 text-gray-800 text-xs font-medium me-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-gray-300">
                          {obj}
                        </span>
            ...
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">Storage Class Name</td>
              <td className="px-6 py-4">
                {resourceDetail?.spec?.storageClassName}
              </td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              <td className="px-6 py-4">Storage</td>
              <td className="px-6 py-4">
                {resourceDetail?.status?.capacity?.storage}
              </td>
            </tr>
            <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
